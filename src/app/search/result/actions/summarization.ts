    ...
    switch (opensearchIndex) {
        ...
        case "american-data-index":
            summaryPrompt = [
                {
                    "role": "user",
                    "content": `Act as a query answering GPT for Objectivist Think Tank, Objective Standard Institute. You answer queries of people using your knowledgebase. Now answer the ${query}, using the following knowledgebase: ${dehydratedSource} Your knowledgebase also contains name of the document, give it when answering so as to making your answer clear article and author names. Strictly answer based on the available knowledge base.`,
                },
            ];
            break;
        case "loc-new-index":
